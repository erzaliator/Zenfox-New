...
(function($) {
     ...
     $.ttwNotificationCenter = function(userOptions) {
        ...
        function openpage()
        {
        	//alert(dump(this.urlvalues));
        	//theForms = document.getElementById('message').contentWindow.document.getElementsByTagName("form");  
        	
        	//document.getElementById('message').contentWindow.document.getElementById(theForms[0].id).submit.click();
        	window.open(this.urlvalues.url,'_blank');
        ...
        Notification.prototype.openpages = function() {
