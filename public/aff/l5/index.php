...
setcookie("landingPage", "LANDINGPAGE_5", time() + (86400 * 30), "/", '.'.$_SERVER['HTTP_HOST']);
...
.ttld1speciality{ float:left; width:340px;  }
.ttld1speciality ul{margin:0px 0px 0px 72px; padding:0px; }
.ttld1speciality ul li{margin:0px; padding:0px; line-height:22px; }
.ttld1float{ float:left; width:230px; padding:5px 0px 0px 0px}
-->
...
<body>
<div class="ttld1m">
<div class="ttld1logot"><div class="ttld1logo"><img src="/css/images/ttld1logo.png" width="256" height="62" /></div>
      <div class="ttld1logocap">Indias's Most Trusted <span>Rummy</span></div></div>
  <div class="ttld1top">
    <div class="ttld1left"><img src="/css/images/ttld1table.jpg" width="416" height="313" /></div>
  ...
  <div class="ttld1botblk">
  <div class="ttld1botwhyplay">
  <div class="ttld1botwhyplayt">Why play at TAASHTIME?</div>
  <div class="ttld1float" >
  <ul>
  <li>Play Rummy win prizes </li>
  <li>100% Legal to   play Rummy</li>
  ...
  <div class="ttld1speciality"> <div class="ttld1botwhyplayt">Taashtime Specialty</div>
