...
setcookie("landingPage", "LANDINGPAGE_1", time() + (86400 * 30), "/", '.'.$_SERVER['HTTP_HOST']);
...
<div class="container">
  ...
  <div class="login-box">
	<form id="player-login-form" enctype="application/x-www-form-urlencoded" action="http://taashtime.com/auth/login" method="post"><dl class="zend_form">
...
<a href = "/en_IN/auth/forgotpassword/trackerId/<?=$trackerId?>/affid/<?=$affId?>/">Forgot Password</a></li></dl></form>      </div>
  ...
  <div id="nav-bar" class="span-24">
    <div class="span-6 pad-t-10"><a href ="http://taashtime.com/index/index/trackerId/<?=$trackerId?>/affid/<?=$affId?>/"><img src="/css/rummy.tld/images/logo-animation.gif" width="238" height="51" alt="Taash Logo" /></a></div>
    <div class="span-25 last prepend-1">
    <ul id="main-menu"> <li><a href="http://taashtime.com/home/index/trackerId/<?=$trackerId?>/affid/<?=$affId?>/" class="home-icon"><p class="menu-pad"><img src="/css/rummy.tld/images/my-home.png"></img></p></a></li>

<li>

<a href="http://taashtime.com/en_IN/game/index/trackerId/<?=$trackerId?>/affid/<?=$affId?>/"><p class="menu-pad">Play Rummy</p></a>

    </li>

<li>

<a href="/content/legal/trackerId/<?=$trackerId?>/affid/<?=$affId?>/"><p class="menu-pad">Is it Legal?</p></a>

    </li>

<li>

<a href="/promotions/index/trackerId/<?=$trackerId?>/affid/<?=$affId?>/"><p class="menu-pad">Promotions</p></a>
...
<a href="/help/howtoplay/trackerId/<?=$trackerId?>/affid/<?=$affId?>/"><p class="menu-pad">How to Play</p></a>
...
<!--
        ...
        <p><a href="http://taashtime.com/game"><img src="/css/rummy.tld/images/home-play-now.png" width="175" height="55" alt="Play Now!" /></a></p>
-->
...
<div class="home-content left">
      ...
      <div class="btn"><a href="/game/quickjoin/flavour/BestOfThreeRummy/amount_type/FREE/trackerId/<?=$trackerId?>/affid/<?=$affId?>/"><img src="/css/rummy.tld/images/join now.png" width="148" height="44" alt="Play Best of Three Rummy Now!" title="BestOfThreeRummy" /></a></div>
      </div>
      </div>
      <!--
      ...
      <div class="btnlast"><a href="/game/quickjoin/flavour/MPPRummy/amount_type/FREE/trackerId/<?=$trackerId?>/affid/<?=$affId?>/"><img src="/css/rummy.tld/images/referbtn.png" width="148" height="44" alt="Play Stake Rummy Now!" title="Refer" /></a></div>
              </div>
      </div>
      <!--
      ...
      <div class="btnlast"><a href="/game/quickjoin/flavour/Indian_Rummy/amount_type/FREE/trackerId/<?=$trackerId?>/affid/<?=$affId?>/"><img src="/css/rummy.tld/images/depositbtn.png" width="148" height="44" alt="Play Syndicate Rummy Now!" title="Syndicate Rummy" /></a></div>
      </div>
      </div>
        ...
        <h2 class="pad-t-20"><strong>Join Now!</strong></h2>
         ...
         -->
	    	...
	    	<div class="reg" id="regForm">
	    		...
	    		<form id="player-registration-form" enctype="application/x-www-form-urlencoded" action="http://taashtime.com/auth/signup/trackerId/<?=$trackerId?>/affid/<?=$affId?>/" method="post"><dl class="zend_form">
...
<div class="footer">
  <div class="container pad-t-20">
    ...
    <div class="span-6 line-links">
      ...
      <p class="black-link"><a href="http://taashtime.com/auth/signup/trackerId/<?=$trackerId?>/affid/<?=$affId?>/"><strong>Join Now!</strong></a></p>
    </div>
...
<!--img src="http://direct.adohana.com/SL6U" width="1" height="1" /-->
