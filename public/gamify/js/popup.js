...
(function($) {
     ...
     $.inviteNotificationCenter = function(userOptions) {
        var defaults,
                options,
                markup,
        ...
        defaults = {
            notification:{
                type:'growl', //none, growl, modal, bar?
                autoHide:false,
                autoHideDelay:30000
            },
            bar:{
            ...
            serverSideHandler:'getmessages.php',
        ...
        markup = {
            tmp:'<div id="tmp"></div>',
            notification:'<div class="invite-notification">' +
 		    '<div class="tthead"></div>' +
                    '<span class="icon"></span>' +
                    '<span class="message"></span>' +
                    '<span class="close"></span>' +
                    '</div>',
            notificationIcon:'<img src="" alt="notification icon"/>',
            notificationDialog:'<div class="invite-notification-modal-inner"></div>',
	    ...
	    notificationMessage:'.tthead',
            ...
            notificationModalOuter:'.invite-modal-outer',
            notificationBar:'.bar',
            notificationBarOuter:'.invite-bar-outer',
        ...
        Notification.prototype.create = function() {
            ...
            if (this.settings.message) {
                ...
                this.player_id = this.settings.player_id;
                this.message_id = this.settings.message_id;
		...
		//set the title
		 if (typeof this.title != 'undefined')
                this.$notification.find('.tthead').html(this.title);
        ...
        Notification.prototype.displayGrowl = function() {
            ...
            this.markup = {
                notification:'<div class="growl-notification">' + '<div class="tthead"></div>' + '<div class="icon"></div>' + '<div class="message"></div>' + '<span class="close"></span>' + '</div>',
                wrapper:'<div class="invite-notification-center-wrapper growl-wrapper"></div>'
            };
        ...
        Notification.prototype.displayModal = function() {
          ...
          //  this.remove();
            ...
            modal.find(cssSelector.notificationClose).click(function() {
               $(modal).remove();
            });
        ...
        Notification.prototype.displayBar = function() {
            ...
            $window = $(window);
            position = this.settings.position || [(($window.width() - 550) / 2), 100];
        ...
        notificationCenter.createNotification = function(notificationOptions, isNew) {
            ...
            //alert ("Exiting createNotification");
            return notification;
