 ...
 * @property string $prebuy_list
 * @property integer $time_to_next_state
 * @property timestamp $game_state_start_time
 * @property integer $no_of_cards_per_strip
 * @property integer $max_no_of_strips_per_request
 * @property string $frontend_ids
 * @property string $categories
 * @property string $extension_name
 * @property string $game_pot
 * 
 * @package    ##PACKAGE##
 ...
 */
abstract class BaseBingoRunningRoom extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('bingo_running_room');
        ...
        $this->hasColumn('pattern_name', 'string', 50, array(
             'type' => 'string',
             'length' => 50,
             'fixed' => true,
             'primary' => false,
        ...
        $this->hasColumn('prebuy_list', 'string', null, array(
             'type' => 'string',
             'fixed' => false,
             'primary' => false,
             'notnull' => false,
        ...
        $this->hasColumn('time_to_next_state', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             'unsigned' => 0,
             'primary' => false,
        ...
        $this->hasColumn('game_state_start_time', 'timestamp', null, array(
             'type' => 'timestamp',
             'primary' => false,
             'notnull' => false,
             'autoincrement' => false,
             ));
        $this->hasColumn('no_of_cards_per_strip', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             'unsigned' => 0,
             'primary' => false,
        ...
        $this->hasColumn('max_no_of_strips_per_request', 'integer', 4, array(
             'type' => 'integer',
             'length' => 4,
             'unsigned' => 0,
             'primary' => false,
        ...
        $this->hasColumn('frontend_ids', 'string', 512, array(
             'type' => 'string',
             'length' => 512,
             'fixed' => false,
             'primary' => false,
        ...
        $this->hasColumn('categories', 'string', 255, array(
             'type' => 'string',
             'length' => 255,
             'fixed' => true,
             'primary' => false,
        ...
        $this->hasColumn('extension_name', 'string', 45, array(
             'type' => 'string',
             'length' => 45,
             'fixed' => true,
             'primary' => false,
        ...
        $this->hasColumn('game_pot', 'string', 512, array(
             'type' => 'string',
             'length' => 512,
             'fixed' => false,
             'primary' => false,
