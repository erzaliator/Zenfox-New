...
class Player_ErrorController extends Zenfox_Controller_Action
{
	...
	public function pageNotFoundAction()
	{
        ...
        $this->_helper->FlashMessenger(array('error' => $this->view->translate("This page does not exist.<br><br>Well, obviously this page exists. But the page you requested does not exist. This page is just here to tell you that the page you requested does not exist.<br><br> Why don't you start from our <a href=\"/game/index\">games page</a>?")));
	...
	private function _ibiboLogin()
	{
		$ibiboSession = new Zend_Session_Namespace('IbiboSession');
		$platformInstance = Zenfox_Applications_Factory::getInstance('ibibo');
		$setUserData = $platformInstance->setUserData();
		if($setUserData['success'])
		{
			$this->_forward('credit','app');
		}
	}
}