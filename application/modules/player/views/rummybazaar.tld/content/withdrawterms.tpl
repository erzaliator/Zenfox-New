...
<p>In order for a player to be able to withdraw money from {$frontendShortName}, they need to meet the conditions as explained hereunder:</p>
<ul class="bullet-normal">
	<li>The player should have played at least one cash game</li>
	<li>The player should have played with a multiple of the sum of deposit and bonus awarded with the same. </li>
	<li>The player must have deposited a minimum of {$minDeposit} </li>
	...
	<li>The player can withdraw a minimum of {$minWithdrawAmount} and a maximum of {$maxWithdrawAmount} per withdrawal</li>
	<li>The player can withdraw for free only {$freeWithdrawTimes} in a month. 
	</li>
	<li>Withdrawals are processed once a week on {$processingDay}. </li>
	<li>Withdrawals submitted post 12:00 PM on {$processingPreviousDay} shall be processed during the next week's cycle. </li>
