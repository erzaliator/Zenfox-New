<?php
class Admin_MainForm extends Zend_Form
{
	private $_form1;
	private $_form2;
	private $_noOfParts;
	...
	public function prepareSubForm($spec, $controller, $action, $formSessNamespace, $countSessNamespace)
    {
        ...
        $this->setSubFormDecorators($subForm)
             ->addSubSubmitButton($subForm,$countSessNamespace)
     ...
     * @return My_Form_Registration
     */
    public function addSubSubmitButton(Zend_Form_SubForm $subForm,$countSessNamespace)
    {
