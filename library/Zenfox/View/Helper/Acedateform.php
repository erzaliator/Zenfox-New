<?php
class Zenfox_View_Helper_Acedateform extends Zend_View_Helper_Abstract
{
	public $view;
	...
	public function acedateform($fromDate, $toDate, $fromHour, $toHour, $fromMinute, $toMinute, $fromPM, $toPM, $items, $formType = NULL)
	{
		?>
		...
		$("#to_date").datepicker({"dateFormat":"yy-mm-dd","changeMonth":true,"changeYear":true,"yearRange":"2010:2013"});
		});
		</script>
		...
		<select id="h_from_time" class="report_time" name="h_from_time" style="max-width: 87px;">
		...
		<select id="m_from_time" class="report_time" name="m_from_time" style="max-width: 87px;">
		...
		<select id="p_from_time" class="report_time" name="p_from_time" style="max-width: 87px;">
		...
		<select id="h_to_time" class="report_time" name="h_to_time" style="max-width: 87px;">
		...
		<select id="m_to_time" class="report_time" name="m_to_time" style="max-width: 87px;">
		...
		<select id="p_to_time" class="report_time" name="p_to_time" style="max-width: 87px;">
