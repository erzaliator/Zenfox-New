...
/**
 *	This class decorates all RummyBazaar forms
 */
class Zenfox_DecoratorForm_RummyBazaar
{
	...
	public $fpLinkDecorator = array(
						'ViewHelper',
						'Errors',
						'Description',
						array('HtmlTag', array('tag' => 'li', 'id' => 'fp_link')),
						array('Description', array('escape' => false, 'tag' => false)));
	public $suLinkDecorator = array(
						'ViewHelper',
						'Errors',
						'Description',
						array('HtmlTag', array('tag' => 'li', 'id' => 'signup_link')),
						array('Description', array('escape' => false, 'tag' => false)));
	...
	public $changeUlTagLabelDecorator = array(
						'ViewHelper',
						'Label',
						'Errors',
						array('HtmlTag', array('tag' => 'li', 'id' => 'rememberMe')));
	...
	public $signupDecorator = array(
						'ViewHelper',
						'Errors',
						array('HtmlTag', array('tag' => 'li', 'class' => 'signup-button')),
						array(array('row' => 'HtmlTag'), array('tag' => 'ul', 'closeOnly' => true)));
	...
	public $termsDecorator = array(
						...
						array('HtmlTag', array('tag' => 'li')),
						array('Description', array('escape' => false, 'tag' => false)));
	public $alMembDecorator = array(
						'ViewHelper',
						'Errors',
						'Description',
						array('HtmlTag', array('tag' => 'li', 'id' => 'already_member')),
						array('Description', array('escape' => false, 'tag' => false)));
